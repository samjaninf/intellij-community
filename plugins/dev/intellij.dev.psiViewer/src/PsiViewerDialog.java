...
public class PsiViewerDialog extends DialogWrapper implements UiDataProvider {
  ...
  private final JCheckBox myUpdatePsiTreeCheckbox;

  private final JBLabel myDialectLabel;
  private final JComboBox<Language> myDialectComboBox;
  private final JLabel myExtensionLabel;
  private final JComboBox<String> myExtensionComboBox;
  private final JPanel myTextPanel;
  private final JSplitPane myTextSplit;
  private final JSplitPane myTreeSplit;

  private final JPanel myPsiTreePanel;
  private final Tree myPsiTree;
  private final JList<String> myRefs;

  private final TitledSeparator myTextSeparator;
  ...
  public PsiViewerDialog(@NotNull Project project, @Nullable Editor selectedEditor) {
    super(project, true, IdeModalityType.MODELESS);
    {
      ...
      myTextSplit.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(), null, TitledBorder.DEFAULT_JUSTIFICATION,
      ...
      panel6.add(myTreeSplit, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
                                                  ...
                                                  GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null,
                                                  new Dimension(200, 200), null, 0, false));
      myTreeSplit.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(), null, TitledBorder.DEFAULT_JUSTIFICATION,
                                                             TitledBorder.DEFAULT_POSITION, null, null));
      myExtensionLabel.setLabelFor(myExtensionComboBox);
      myDialectLabel.setLabelFor(myDialectComboBox);
      label1.setLabelFor(myFileTypeComboBox);
    }
    ...
    myPsiViewerPropertiesTabViewModel =
      new PsiViewerPropertiesTabViewModel(myProject, myCoroutineScope, myOriginalPsiFile, PsiViewerSettings.getSettings(), (psiElement) -> {
        focusTree();
