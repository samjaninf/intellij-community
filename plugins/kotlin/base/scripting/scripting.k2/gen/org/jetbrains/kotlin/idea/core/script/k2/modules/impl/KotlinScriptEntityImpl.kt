...
// Process linked entities that are connected without a builder
        ...
        override fun afterModification() {
            ...
            val collection_relatedModuleIds = getEntityData().relatedModuleIds
            if (collection_relatedModuleIds is MutableWorkspaceList<*>) {
                collection_relatedModuleIds.cleanModificationUpdateAction()
            }
        ...
        override var relatedModuleIds: MutableList<ModuleId>
            get() {
                val collection_relatedModuleIds = getEntityData().relatedModuleIds
                if (collection_relatedModuleIds !is MutableWorkspaceList) return collection_relatedModuleIds
                if (diff == null || modifiable.get()) {
                    collection_relatedModuleIds.setModificationUpdateAction(relatedModuleIdsUpdater)
                } else {
                    collection_relatedModuleIds.cleanModificationUpdateAction()
                }
                return collection_relatedModuleIds
            }
            set(value) {
                checkModificationAllowed()
                getEntityData(true).relatedModuleIds = value
...
// TODO verify logic
    ...
    override fun clone(): KotlinScriptEntityData {
        ...
        clonedEntity.relatedModuleIds = clonedEntity.relatedModuleIds.toMutableWorkspaceList()
