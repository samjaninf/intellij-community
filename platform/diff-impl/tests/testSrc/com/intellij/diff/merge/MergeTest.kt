...
class MergeTest : MergeTestBase() {
  fun testChangeTypes() {
    ...
    doTest("x_y_z a x", "x_y_z a x", "x_y_z a x", 0) {
    }
  ...
  fun testResolve() {
    ...
    doTest2("y z_Y_x y", "x y z_Y_x y z", "x y_Y_y z") {
      0.resolve()
      0.assertResolved(BOTH)
      0.assertContent("y")
  ...
  fun testRangeModification() {
    doTest1("X_x_y_z_Y", "X_a_b_c_Y", "X_x_y_z_Y") {
    ...
    doTest1("A_X_x_y_z_Y", "A_X_a_b_c_Y", "A_X_x_y_z_Y") {
      0.assertContent("a_b_c", 2, 5)
      checkUndo(1) { replaceText("X_a_b", "q_w_e") }
      0.assertContent("c")
    }

    doTest1("X_x_y_z_Y_A", "X_a_b_c_Y_A", "X_x_y_z_Y_A") {
      0.assertContent("a_b_c")
      checkUndo(1) { replaceText("c_Y", "q") }
      0.assertContent("a_b")
    }

    doTest1("A_X_x_Y_A", "A_X_b_Y_A", "A_X_x_z_Y_A") {
      0.assertContent("b")
  ...
  fun testNoConflicts() {
    doTest2("a_Ins1_b_ccc", "a_b_ccc", "a_b_dddd") {
  ...
  fun testConflictingChange() {
    doTest("1_2_3_X_a_b_c_Y_Ver1_Ver12_Z",
  ...
  fun testInvalidatingChange() {
    doTest1("X_1_2_Y", "X_1_Ins_2_Y", "X_1_2_Y") {
  ...
  fun testIgnoreChangeAction() {
    doTest2("X_1_Y_2_Z", "X_a_Y_b_Z", "X_a_Y_B_Z") {
      0.assertType(MODIFIED)
      1.assertType(CONFLICT)
  ...
  fun testLongBase() {
    doTest1("X_1_2_3_Z", "X_1_b_3_d_e_f_Z", "X_a_b_c_Z") {
  ...
  fun testReplaceBaseWithBranch() {
    doTest2("a_X_b_c", "A_X_B_c", "1_X_1_c") {
      0.assertType(CONFLICT)
      1.assertType(CONFLICT)
  ...
  fun testError3() {
    doTestN("original_local_local_local_original_",
  ...
  fun testIgnored() {
    doTest(" x_new_y_z", "x_ y _z", "x_y _new_ z", 5, IgnorePolicy.IGNORE_WHITESPACES) {
      0.assertRange(0, 1, 0, 1, 0, 1)
    ...
    doTest(" x_new_y1_z", "x_ y _z", "x_y2 _new_ z", 3, IgnorePolicy.IGNORE_WHITESPACES) {
      0.assertRange(0, 1, 0, 1, 0, 1)
    ...
    doTest(" x_new_y_z", "x_ y _z", "x_y _new_ z", 1, IgnorePolicy.DEFAULT) {
