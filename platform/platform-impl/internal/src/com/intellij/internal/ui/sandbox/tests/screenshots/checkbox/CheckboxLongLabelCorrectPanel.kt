...
internal class CheckboxLongLabelCorrectPanel : UISandboxScreenshotPanel() {
  override val title: String = "Correct"

  override fun createContentForScreenshot(disposable: Disposable): JComponent {
    return panel {
      row {
        checkBox("""<html>Insert selected suggestion by pressing<br/>space, dot, or other context-dependent keys</html>""").apply {
