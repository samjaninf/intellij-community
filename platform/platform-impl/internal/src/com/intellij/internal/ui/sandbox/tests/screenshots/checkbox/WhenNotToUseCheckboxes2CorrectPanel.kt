 ...
 */
internal class WhenNotToUseCheckboxes2CorrectPanel : UISandboxScreenshotPanel() {
  override val title: String = "Correct"

  override fun createContentForScreenshot(disposable: Disposable): JComponent {
    return panel {
      buttonsGroup("Antialiasing:") {
        row { checkBox("Greyscale").apply { component.isSelected = true } }
        row { checkBox("No antialiasing") }
      }
    }
  }
}